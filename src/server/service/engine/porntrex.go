...
func NewPornTrexEngine(appConfig *config.AppConfig, torClient *tor.TorClient) *PornTrexEngine {
	return &PornTrexEngine{NewBaseEngine("porntrex", "PornTrex", "https://www.porntrex.com", 4, appConfig, torClient)}
}
