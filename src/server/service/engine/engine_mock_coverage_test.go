...
func TestSearchStreamWithOperators_WithMockEngine_ChannelReceivesData(t *testing.T) {
	...
	ch := m.SearchStreamWithOperators(ctx, "stream test", 1, nil, nil, nil, nil, nil, false, 0, false, 0, "")
	if ch == nil {
...
func TestSearchStreamWithOperators_WithExclusion_FiltersResult(t *testing.T) {
	...
	ch := m.SearchStreamWithOperators(ctx, "stream video", 1, nil, nil, []string{"excluded"}, nil, nil, false, 0, false, 0, "")
	for range ch {
	}
}
...
func TestSearchStreamWithOperators_WithExactPhrase_FiltersResult(t *testing.T) {
	...
	ch := m.SearchStreamWithOperators(ctx, "stream video", 1, nil, []string{"exact phrase"}, nil, nil, nil, false, 0, false, 0, "")
	for range ch {
	}
}
...
func TestSearchStreamWithOperators_WithPerformerFilter_FiltersResult(t *testing.T) {
	...
	ch := m.SearchStreamWithOperators(ctx, "stream video", 1, nil, nil, nil, nil, []string{"jane"}, false, 0, false, 0, "")
	for range ch {
	}
}
...
func TestSearchStreamWithOperators_WithMinQuality_FiltersResult(t *testing.T) {
	...
	ch := m.SearchStreamWithOperators(ctx, "stream video", 1, nil, nil, nil, nil, nil, false, 480, false, 0, "")
	for range ch {
	}
}
...
func TestSearchStreamWithOperators_AIFilter_FiltersAIContent(t *testing.T) {
	...
	ch := m.SearchStreamWithOperators(ctx, "stream video", 1, nil, nil, nil, nil, nil, false, 0, false, 0, "")
	for range ch {
	}
}
...
func TestSearchStreamWithOperators_QualityFilter_FiltersLowQuality(t *testing.T) {
	...
	ch := m.SearchStreamWithOperators(ctx, "stream quality", 1, nil, nil, nil, nil, nil, false, 480, false, 0, "")
	for range ch {
	}
}
...
func TestSearchStreamWithOperators_UserMinDuration_Override(t *testing.T) {
	...
	ch := m.SearchStreamWithOperators(ctx, "stream video", 1, nil, nil, nil, nil, nil, false, 0, false, 120, "")
	for range ch {
	}
}
