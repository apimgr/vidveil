...
func TestRenderTemplate_UnknownName_Returns500(t *testing.T) {
	...
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "totally-unknown-template", map[string]interface{}{})
...
func TestRenderTemplate_ValidName_EmptyFS_Returns500(t *testing.T) {
	...
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "home", map[string]interface{}{})
	if rr.Code != http.StatusInternalServerError {
...
func TestRenderTemplate_AboutName_EmptyFS_Returns500(t *testing.T) {
	...
	h := newRenderTestHandler()
	rr := httptest.NewRecorder()
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "about", map[string]interface{}{})
	if rr.Code != http.StatusInternalServerError {
...
func TestRenderTemplate_Search_Returns500(t *testing.T) {
	...
	h := newRenderTestHandler()
	rr := httptest.NewRecorder()
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "search", map[string]interface{}{})
	if rr.Code == http.StatusOK {
...
func TestRenderTemplate_Preferences_Returns500(t *testing.T) {
	...
	h := newRenderTestHandler()
	rr := httptest.NewRecorder()
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "preferences", map[string]interface{}{})
	if rr.Code == http.StatusOK {
...
func TestRenderTemplate_AgeVerify_Returns500(t *testing.T) {
	...
	h := newRenderTestHandler()
	rr := httptest.NewRecorder()
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "age-verify", map[string]interface{}{})
	if rr.Code == http.StatusOK {
...
func TestRenderTemplate_ContentRestricted_Returns500(t *testing.T) {
	...
	h := newRenderTestHandler()
	rr := httptest.NewRecorder()
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "content-restricted", map[string]interface{}{})
	if rr.Code == http.StatusOK {
...
func TestRenderTemplate_ContentBlocked_Returns500(t *testing.T) {
	...
	h := newRenderTestHandler()
	rr := httptest.NewRecorder()
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "content-blocked", map[string]interface{}{})
	if rr.Code == http.StatusOK {
...
func TestRenderTemplate_Privacy_Returns500(t *testing.T) {
	...
	h := newRenderTestHandler()
	rr := httptest.NewRecorder()
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "privacy", map[string]interface{}{})
	if rr.Code == http.StatusOK {
...
func TestRenderTemplate_NojsHome_Returns500(t *testing.T) {
	...
	h := newRenderTestHandler()
	rr := httptest.NewRecorder()
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "nojs/home", map[string]interface{}{})
	if rr.Code == http.StatusOK {
...
func TestRenderTemplate_NojsSearch_Returns500(t *testing.T) {
	...
	h := newRenderTestHandler()
	rr := httptest.NewRecorder()
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "nojs/search", map[string]interface{}{})
	if rr.Code == http.StatusOK {
...
func TestRenderTemplate_NojsPreferences_Returns500(t *testing.T) {
	...
	h := newRenderTestHandler()
	rr := httptest.NewRecorder()
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "nojs/preferences", map[string]interface{}{})
	if rr.Code == http.StatusOK {
...
func TestRenderTemplate_NojsAbout_Returns500(t *testing.T) {
	...
	h := newRenderTestHandler()
	rr := httptest.NewRecorder()
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "nojs/about", map[string]interface{}{})
	if rr.Code == http.StatusOK {
...
func TestRenderTemplate_NojsAgeVerify_Returns500(t *testing.T) {
	...
	h := newRenderTestHandler()
	rr := httptest.NewRecorder()
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "nojs/age-verify", map[string]interface{}{})
	if rr.Code == http.StatusOK {
...
func TestRenderTemplate_NojsPrivacy_Returns500(t *testing.T) {
	...
	h := newRenderTestHandler()
	rr := httptest.NewRecorder()
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "nojs/privacy", map[string]interface{}{})
	if rr.Code == http.StatusOK {
...
func TestRenderTemplate_WithActiveNavSet_NoOverwrite(t *testing.T) {
	...
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "home", data)
...
func TestRenderTemplate_WithQuerySet_NoOverwrite(t *testing.T) {
	...
	h.renderTemplate(rr, httptest.NewRequest(http.MethodGet, "/", nil), "search", data)
