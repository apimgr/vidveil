...
func NewSuperPornEngine(appConfig *config.AppConfig) *SuperPornEngine {
	return &SuperPornEngine{NewBaseEngine("superporn", "SuperPorn", "https://www.superporn.com", 3, appConfig)}
}
