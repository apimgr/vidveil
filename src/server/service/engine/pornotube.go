...
func NewPornotubeEngine(appConfig *config.AppConfig, torClient *tor.TorClient) *PornotubeEngine {
	return &PornotubeEngine{NewBaseEngine("pornotube", "Pornotube", "https://pornotube.com", 4, appConfig, torClient)}
}
