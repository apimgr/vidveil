...
func NewPornHatEngine(appConfig *config.AppConfig, torClient *tor.TorClient) *PornHatEngine {
	return &PornHatEngine{NewBaseEngine("pornhat", "PornHat", "https://www.pornhat.com", 4, appConfig, torClient)}
}
