...
func genericSearch(ctx context.Context, e *BaseEngine, url, selector string) ([]models.Result, error) {
...
func parseGenericVideoItem(s *goquery.Selection, baseURL, sourceName, sourceDisplay string) models.Result {
	var r models.Result
