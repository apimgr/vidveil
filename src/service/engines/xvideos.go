...
func (e *XVideosEngine) Search(ctx context.Context, query string, page int) ([]model.Result, error) {
...
func (e *XVideosEngine) convertToResult(item *parsers.VideoItem) model.Result {
	return model.Result{
