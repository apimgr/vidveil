...
func NewPornTubeEngine(appConfig *config.AppConfig, torClient *tor.TorClient) *PornTubeEngine {
	return &PornTubeEngine{NewBaseEngine("porntube", "PornTube", "https://www.porntube.com", 3, appConfig, torClient)}
}
